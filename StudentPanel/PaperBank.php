		...
		<form method="post" enctype="multipart/form-data">
			<div class="row" style="margin-bottom:15px;">
				<div class="col-md-12 col-lg-12 col-xs-12 text-center">
					<span style="font-size:25px;font-weight:bold;color:blue;">Paper Bank</span>
						<p style="font-weight:bold;text-transform:uppercase">Free Access To All Papers...</p>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-lg-4 col-xs-12 text-center" style="padding:20px;">
					<span style="text-transform:uppercase;font-weight:bold;font-size:20px;color:black;">Master Of Computer Application</span><br>
						<a href="" style="margin-top:100px;clear:both;text-decoration:none;text-transform:uppercase;background-color:red;color:white;padding:5px;" title="Download" class="text-center;">Download</a>
				</div>
				
				<!-- For BCA -->
				<div class="col-md-4 col-lg-4 col-xs-12 text-center" style="padding:20px;">
					<span style="text-transform:uppercase;font-weight:bold;font-size:20px;color:black;">Bachelor Of Computer Application<br></span>
						<a href="" style="margin-top:100px;clear:both;text-decoration:none;text-transform:uppercase;background-color:green;color:white;padding:5px;" title="Download" class="text-center;">Download</a>
				</div>
				...
				<div class="col-md-4 col-lg-4 col-xs-12 text-center" style="padding:20px;">
					<span style="text-transform:uppercase;font-weight:bold;font-size:20px;color:black;">Bachelor Of Business Administration<br></span>
						<a href="" style="margin-top:100px;clear:both;text-decoration:none;text-transform:uppercase;background-color:blue;color:white;padding:5px;" title="Download" class="text-center;">Download</a>
				</div>
