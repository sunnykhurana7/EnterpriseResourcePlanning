		...
		<div class="container" style="margin-top:100px;">
		  ...
		  <div class="row" style="margin-bottom:15px;">
				<div class="col-md-12 col-lg-12 col-xs-12 text-center">
					<span style="font-size:25px;font-weight:bold;color:blue;">VIEW EVENTS UPLOADED BY YOU</span>
				</div>
			</div>
				...
				<div class="row text-center">
				  	<!-- just We have to create a table -->
						<table class="table table-bordered table-hover">
                          ...
                          <?php
                          $count =  "";
                            if($stmt = $conn->query("select * from   student_events where username = '".$_SESSION['studentusername']."'")){
                                while($q = $stmt->fetch_array(MYSQLI_ASSOC)){
                                    $count++;
                          ?>
						  ...
						  <!-- Body Of The Table -->
							<tbody style="cursor:pointer;">
							 <tr>
							  ...
							  <td style="text-transform: uppercase;color: red;"><?php echo $q['title'];?></td>
							  <td style="text-transform: uppercase"><?php echo $q['description'];?></td>
