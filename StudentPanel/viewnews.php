		...
		<div class="container" style="margin-top:100px;">
		  ...
		  <div class="row" style="margin-bottom:15px;">
				<div class="col-md-12 col-lg-12 col-xs-12 text-center">
					<span style="font-size:25px;font-weight:bold;color:blue;">VIEW NEWS UPLOADED BY YOU</span>
				</div>
			</div>
						...
						<table class="table table-bordered table-hover">
						  ...
						  <!-- Body Of The Table -->
							<tbody style="cursor:pointer;">
                                ...
                                <?php 
                                       $count = "";
                                       if($stmt = $conn->query("select * from studen_news where username = '".$_SESSION['studentusername']."'")){
							 ...
							 <tr>
							  ...
							  <td style="text-transform: uppercase;color: red"><?php echo $p['title']; ?></td>
							  <td style="text-transform: capitalize"><?php echo $p['description']; ?></td>
