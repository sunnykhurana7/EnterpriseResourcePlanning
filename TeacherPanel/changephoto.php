...
<?php
  if(isset($_POST['change'])){
      $file = $_FILES['file']['name'];
         if($stmt = $conn->query("update admin_register_teacher set image = '".$file."' where username = '".$_SESSION['teacherusername']."'")){
        move_uploaded_file($_FILES['file']['tmp_name'],'photos/'.$file);
		...
		<div class="container" style="margin-top:100px;">
		  <form method = "post" enctype="multipart/form-data">	
			...
			<div class="row" style="margin-top:15px;">
                ...
                ?>
			        <img src="photos/<?php echo $r['image']; ?>" style="width: 250px;height: 250px;margin-left: 53px;" >
