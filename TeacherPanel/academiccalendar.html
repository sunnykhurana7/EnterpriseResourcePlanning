		...
		<div class="container" style="margin-top:100px;">
			...
			<div class="row" style="margin-bottom:15px;">
				<div class="col-md-12 col-lg-12 col-xs-12 text-center">
					<span style="font-size:25px;font-weight:bold;color:blue;">ACADEMIC CALENDAR</span>
				</div>
			</div>
	
			<div class="row">
				<div class="col-md-12 col-lg-12 col-xs-12">
					<img src="images/2016-calendar-template-06.jpg" alt="No image" class="img-responsive">	
				</div>
			</div>
